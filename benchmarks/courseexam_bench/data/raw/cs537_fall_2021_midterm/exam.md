...
```json
{
  ...
  "points": 1,
  "type": "ExactMatch",
  "tags": ["operating-systems","scheduling","beos"],
...
```json
{
  ...
  "points": 1,
  "type": "ExactMatch",
  "tags": ["operating-systems","scheduling","fifo"],
...
```json
{
  ...
  "points": 1,
  "type": "ExactMatch",
  "tags": ["memory-management","virtual-memory","base-bounds"],
...
```json
{
  ...
  "points": 1,
  "type": "ExactMatch",
  "tags": ["memory-protection","base-bounds","process-switch"],
...
```json
{
  ...
  "points": 1,
  "type": "ExactMatch",
  "tags": ["memory-management","static-relocation","isolation"],
...
```json
{
  ...
  "points": 1,
  "type": "ExactMatch",
  "tags": ["memory-allocation","paging","dos"],
...
```json
{
  ...
  "points": 1,
  "type": "ExactMatch",
  "tags": ["kernel-mode","supervisor","minux"],
...
```json
{
  ...
  "points": 1,
  "type": "ExactMatch",
  "tags": ["tlb","translation","virtual-memory"],
...
The Minux scheduler uses a new scheduler called “highest PID first” (i.e., the job with the highest PID always runs, and to completion). Assume job PID=1 arrives at time T=0, with length 10; PID=2 arrives at T=2, length=6; PID=3 arrives at T=4, with length 4. What is the average response time of this approach in this example?
...
```json
{
  ...
  "points": 1,
  "type": "ExactMatch",
  "tags": ["zOS","proportional-share","scheduling"],
...
```json
{
  ...
  "points": 1,
  "type": "ExactMatch",
  "tags": ["zOS","tlb-misses","interrupts"],
...
Your answer should be one letter only (A, B, C, or E).
...
```json
{
  ...
  "points": 1,
  "type": "ExactMatch",
  "tags": ["zOS","kernel-registers","trapping"],
...
```json
{
  ...
  "points": 1,
  "type": "ExactMatch",
  "tags": ["operating-systems","truth-values"],
...
Which is true about operating systems?
