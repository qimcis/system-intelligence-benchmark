...
```json
{
  "exam_id": "cs_537_fall_2021_midterm",
...
```json
{
  ...
  "points": 1,
  "type": "ExactMatch",
  "tags": ["operating-systems", "process-management", "process-states"],
...
```json
{
  ...
  "points": 1,
  "type": "ExactMatch",
  "tags": ["operating-systems", "memory-management", "addressing"],
...
MINUX:  Next up is Minus, who created Minux.  Minux  uses  kernel  mode,  user  mode,  and  a  new  mode  called  “supervisor”  mode.  When  a  user 
...
Assuming a two-level multi-level page table (32-bit virtual addresses, 4 KB pages, 4-byte PTE size), 
